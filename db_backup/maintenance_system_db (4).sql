...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2024 at 08:25 PM
...
(9, 'ideapad 3', '2024-12-13 19:16:39');
...
(20, 'ff', '2024-12-13 17:50:08', 'fff', 'custom', '#e3caca'),
(21, 'ffffff', '2024-12-13 19:03:03', 'asdf', 'custom', '#000000'),
(22, 'fffffff', '2024-12-13 19:04:09', 'fffffffffffffff', 'custom', '#e32b2b');
...
ALTER TABLE `task`
  ...
  ADD KEY `task_ibfk_1` (`customer_id`),
  ADD KEY `task_ibfk_2` (`machine_id`);
...
ALTER TABLE `task_status`
  ...
  ADD KEY `task_status_ibfk_3` (`status_id`);
...
--
ALTER TABLE `machine_model`
  MODIFY `model_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `status`
--
ALTER TABLE `status`
  MODIFY `status_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `machine`
  ADD CONSTRAINT `machine_ibfk_1` FOREIGN KEY (`brand_id`) REFERENCES `machine_brand` (`brand_id`),
  ADD CONSTRAINT `machine_ibfk_2` FOREIGN KEY (`model_id`) REFERENCES `machine_model` (`model_id`);

--
-- Constraints for table `task`
--
ALTER TABLE `task`
  ADD CONSTRAINT `task_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
...
ALTER TABLE `task_status`
  ...
  ADD CONSTRAINT `task_status_ibfk_3` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`);
COMMIT;
